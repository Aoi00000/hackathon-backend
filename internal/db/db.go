...
// ============================================================
// 実装詳細メモ:
// MySQL接続を作成し、接続プールと疎通確認をまとめます。
// ハンドラやRepositoryがdriver設定を知らなくてよいよう、DB初期化はこのファイルへ閉じ込めます。
package db
...
func Open(cfg config.Config) (*sql.DB, error) {
	...
	// dsn はMySQLドライバへ渡す接続文字列です。
	// Cloud SQLのUnix socket形式とローカルTCP形式で組み立て方が違うため、ここで分岐してからsql.Openへ渡します。
	var dsn string
